#!/usr/bin/env python3
"""
Test script for YouTube Shorts download functionality
"""
...
def test_youtube_shorts_download():
    """Test downloading a YouTube Shorts video"""

    # Example YouTube Shorts URL (replace with a real one)
    ...
    print(f"📥 Testing download for: {shorts_url}")
...
def test_youtube_advanced_download():
    """Test advanced YouTube download with metadata"""

    print("\n🔬 Testing Advanced YouTube Download")
    print("=" * 50)

    # Example regular YouTube video URL
...
if __name__ == "__main__":
    print("🚀 YouTube Shorts Download Test Suite")
    print("=" * 60)
    ...
    # Run tests
    test_youtube_shorts_download()
    test_youtube_advanced_download()

    print("\n🎯 Test completed!")
    print("\n📝 Note: Replace the example URLs with real YouTube/Shorts URLs to test")
